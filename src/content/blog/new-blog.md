...
Also gives me a chance to remake my old website using [Astro](https://astro.build/). The site uses the astro [portfolio template](https://astro.build/themes/details/portfolio/) with the blog page coming from flexdinesh's [Blogster Bubblegum template](https://astro.build/themes/details/blogster-bubblegum/). Initial brand design is difficult for me, but give me any starting point and I will run. Now just to pick pretty colours...
